# USAGE
# python post_process.py -i http://192.168.68.104:8080/video
# python post_process.py -i rec/vid#.mp4 -o vid#_out.avi -d 0
# python post_process.py -i test/z.jpg -o q1.png
# python post_process.py -i group/p2.jpg -o g1.png
# python post_process.py -i hallway/h#.jpg -o h#.png
